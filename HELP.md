...
* The original package name 'com.vinay.twophase.example.two-phase-commit' is invalid and this project uses 'com.vinay.twophase.example.twophasecommit' instead.
...
* [Spring for Apache ActiveMQ 5](https://docs.spring.io/spring-boot/docs/2.7.9/reference/htmlsingle/#messaging.jms.activemq)
